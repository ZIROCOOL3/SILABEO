...
namespace Silabeo
{
	public class SeparadorDeSilabas
	{
		...
		public String ultPal;        // Última palabra tratada, se guarda para
        ...
        string PalabraSilaba = string.Empty;
        public string SeparadorSilaba = string.Empty;
        ...
        public string PalabraSilabas(String palabra)
        {
            PalabraSilaba = string.Empty;
            Calcular(palabra);
            //quito ultima raya
            int largo = PalabraSilaba.Length;
            if (largo!=0)
            {
                PalabraSilaba = PalabraSilaba.Substring(0, largo - 1) + " ";
		...
		void PosicionSilabas () {
            ...
            for (int actPos = 0; actPos < lonPal; )
			{
                ...
                PalabraSilaba = PalabraSilaba + ultPal.Substring(Inicio, PosF- Inicio) + SeparadorSilaba;////////////
                Inicio = PosF ;
